...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/assets/img/navbar-logo.svg" alt="" /></a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        ...
                        <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-shopee-so"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-bi bi-whatsapp"></i></a>
                    </div>
